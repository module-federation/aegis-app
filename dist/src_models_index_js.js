...
exports.modules = {
  ...
  \********************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _models_customer__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*! ../models/customer */ "./src/models/customer.js"
        );
      /* harmony import */ var _models_mixins__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! ../models/mixins */ "./src/models/mixins.js");
      /* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
      /* harmony import */ var _datasources_datasource_mongodb__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(
      ...
      var Customer = {
        ...
        datasource: {
          factory:
            _datasources_datasource_mongodb__WEBPACK_IMPORTED_MODULE_3__.DataSourceAdapterMongoDb,
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _order__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ./order */ "./src/config/order.js");
      /* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! ./user */ "./src/config/user.js");
      /* harmony import */ var _customer__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(/*! ./customer */ "./src/config/customer.js");
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _models_order__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ../models/order */ "./src/models/order.js");
      /* harmony import */ var _models_mixins__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! ../models/mixins */ "./src/models/mixins.js");
      /* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
      /* harmony import */ var _datasources_datasource_file_adapter__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(
          /*! ../datasources/datasource-file-adapter */ "./src/datasources/datasource-file-adapter.js"
        );
      ...
      var Order = {
        ...
        datasource: {
          factory:
            _datasources_datasource_file_adapter__WEBPACK_IMPORTED_MODULE_3__.DataSourceFileAdapter,
          cacheSize: 2000,
  ...
  \****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _models_mixins__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ../models/mixins */ "./src/models/mixins.js");
      /* harmony import */ var _models_user__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! ../models/user */ "./src/models/user.js");
      /* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
  ...
  /***/ "./src/datasources/datasource-file-adapter.js":
    /*!****************************************************!*\
  !*** ./src/datasources/datasource-file-adapter.js ***!
  \****************************************************/
    /*! namespace exports */
    ...
    /***/ (
      ...
      var DataSourceFileAdapter = function DataSourceFileAdapter(url) {
        var cacheSize =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : 2000;
        var DataSourceFile = arguments.length > 2 ? arguments[2] : undefined;
  ...
  \*********************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _services_event_service__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
  ...
  \**************************/
    ...
    /***/ (
      ...
      /* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_0___default =
      ...
      function encrypt(text) {
        var cipher =
          crypto__WEBPACK_IMPORTED_MODULE_0___default().createCipheriv(
            algo,
            key,
            iv
          );
      ...
      function decrypt(cipherText) {
        ...
        var decipher =
          crypto__WEBPACK_IMPORTED_MODULE_0___default().createDecipheriv(
            algo,
            key,
            iv
          );
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _mixins__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ./mixins */ "./src/models/mixins.js");
      /* harmony import */ var _make_adapters__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(
          /*! ./make-adapters */ "./src/models/make-adapters.js"
        );
      /* harmony import */ var _services_mock__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(
          /*! ../services-mock */ "./src/services-mock/index.js"
        );
      /* harmony import */ var _adapters__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(/*! ../adapters */ "./src/adapters/index.js");
  ...
  \******************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
      /* harmony import */ var util__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! util */ "util");
      /* harmony import */ var util__WEBPACK_IMPORTED_MODULE_1___default =
        /*#__PURE__*/ __webpack_require__.n(util__WEBPACK_IMPORTED_MODULE_1__);
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _mixins__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(/*! ./mixins */ "./src/models/mixins.js");
      /* harmony import */ var _check_payload__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(
  ...
  \*********************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _event_dispatcher__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*! ./event-dispatcher */ "./src/event-dispatcher.js"
        );
      /* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(/*! ./lib/utils */ "./src/lib/utils.js");
      ...
      var dispatcher =
        new _event_dispatcher__WEBPACK_IMPORTED_MODULE_0__.EventDispatcher();
  ...
  \**********************************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _service_registry__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(
  ...
  \************************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _address_service__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*! ./address-service */ "./src/services-mock/address-service.js"
        );
      /* harmony import */ var _payment_service__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(
          /*! ./payment-service */ "./src/services-mock/payment-service.js"
        );
      /* harmony import */ var _shipping_service__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(
          /*! ./shipping-service */ "./src/services-mock/shipping-service.js"
        );
      /* harmony import */ var _event_service__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(
          /*! ./event-service */ "./src/services-mock/event-service.js"
        );
      /* harmony import */ var _inventory_service__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(

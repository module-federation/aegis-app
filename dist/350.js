...
/* harmony import */ var _util_check_payload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/check-payload */ "./src/domain/util/check-payload.js");
...
var invalidStatusChange = function invalidStatusChange(from, to) {
  return function (o, propVal) {
    return propVal === to && o[_util_mixins__WEBPACK_IMPORTED_MODULE_0__.prevmodel].orderStatus === from;
  };
};
...
var processPendingOrder = (0,_util_utils__WEBPACK_IMPORTED_MODULE_1__.asyncPipe)(getCustomerOrder, verifyInventory, verifyPayment, verifyAddress);
...
function processUpdate(model, changes) {
  ...
  var updates = model[premixins] ? _utils__WEBPACK_IMPORTED_MODULE_0__.compose.apply(void 0, _toConsumableArray(model[premixins].values()))(changes) : changes;
  var updated = _objectSpread(_objectSpread({}, model), updates);
  return model[postmixins] ? _utils__WEBPACK_IMPORTED_MODULE_0__.compose.apply(void 0, _toConsumableArray(model[postmixins].values()))(updated) : updated;
}
  ...
  return function (o) {
    ...
    var encryptProps = function encryptProps(obj) {
      return keys.map(function (key) {
        return obj[key] ? _defineProperty({}, key, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.encrypt)(obj[key])) : {};
      }).reduce(function (p, c) {
        return _objectSpread(_objectSpread({}, p), c);
      });
    };
    return _objectSpread(_objectSpread({
      ...
      decrypt: function decrypt() {
        var _this = this;
        return keys.map(function (key) {
          return _this[key] ? _defineProperty({}, key, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.decrypt)(_this[key])) : {};
        }).reduce(function (p, c) {
          return _objectSpread(_objectSpread({}, p), c);
        }, {});
      }
...
var hashPasswords = function hashPasswords() {
  ...
  return function (o) {
    ...
    function hashPwds(obj) {
      return keys.map(function (key) {
        return obj[key] ? _defineProperty({}, key, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.hash)(obj[key])) : {};
      }).reduce(function (p, c) {
        return _objectSpread(_objectSpread({}, p), c);
      });
    }
...
function evaluateUniqueness(v, o, propVal) {
  var compareVal = v.unique.encrypted ? (0,_utils__WEBPACK_IMPORTED_MODULE_0__.encrypt)(propVal) : propVal;

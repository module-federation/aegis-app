...
/*! export AppFabricClient [provided] [no usage info] [missing usage info prevents renaming] -> ./src/config/webswitch.js .AppFabricClient */
...
/* harmony export */   "AppFabricClient": () => /* reexport safe */ _webswitch__WEBPACK_IMPORTED_MODULE_4__.AppFabricClient
/* harmony export */ });
...
/*!*********************************!*\
  ...
  \*********************************/
/*! namespace exports */
/*! export AppFabricClient [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AppFabricClient": () => /* binding */ AppFabricClient
/* harmony export */ });
/* harmony import */ var _domain_webswitch_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../domain/webswitch-client */ "./src/domain/webswitch-client.js");
...
var AppFabricClient = {
  ...
  endpoint: 'app-fabric',
  factory: _domain_webswitch_client__WEBPACK_IMPORTED_MODULE_0__.makeClient,
  ports: {
    serviceLocatorInit: {
...
/***/ "./src/domain/webswitch-client.js":
/*!****************************************!*\
  !*** ./src/domain/webswitch-client.js ***!
  \****************************************/
/*! namespace exports */
...
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! nanoid */ "webpack/sharing/consume/default/nanoid/nanoid");
...
var broker = new (events__WEBPACK_IMPORTED_MODULE_1___default())();
...
function services() {
  return options.listServices ? (options.listServices(), _readOnlyError("serviceList")) : serviceList;
}
...
function _resolveUrl() {
  _resolveUrl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return this.serviceLocatorInit({
              name: SERVICENAME,
          ...
          case 2:
            ...
            _context5.next = 5;
            return this.serviceLocatorAnswer();

          case 5:
            return _context5.abrupt("return", constructUrl());

          case 6:
            return _context5.abrupt("return", this.serviceLocatorListen());
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            _context6.next = 6;
            return resolveUrl.call(this);

          case 6:
            url = _context6.sent;
            _context6.next = 9;
            return this.websocketConnect(url, {
              agent: false,
              headers: headers,
          ...
          case 9:
            this.websocketOnClose(function (code, reason) {
              console.log('received close frame', code, reason.toString()); //this.ws.removeAllListeners()

              clearTimeout(timerId); // this.ws = null

              setTimeout(__connect.bind(_this4), 3000);
            });
            this.websocketOnOpen(function () {
              console.log('connection open');

              _this4.websocketSend(telemetry.call(_this4));

              broker.once('timeout', timeout.bind(_this4));
              heartbeat.call(_this4);
              setTimeout(sendQueuedMsgs.bind(_this4), 3000).unref();
            });
            this.websocketOnMessage(function (message) {
              try {
                ...
                broker.listeners('*').forEach(function (listener) {
            ...
            this.websocketOnError(function (error) {
...
function _send() {
  _send = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(msg) {
    var sent;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return this.websocketSend(handle, encode(msg), {
              binary: true,
              headers: _objectSpread(_objectSpread({}, headers), {}, {
                'idempotency-key': (0,nanoid__WEBPACK_IMPORTED_MODULE_4__.nanoid)()
              })
            });
...
function _sendQueuedMsgs() {
  _sendQueuedMsgs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    var sent;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            if (!(this.sendQueue.length > 0 && sent)) {
              _context8.next = 8;
              break;
            }

            _context8.next = 5;
            return send(this.sendQueue.pop());
...
function __publish(_x2) {
  return _publish.apply(this, arguments);
}

function _publish() {
  _publish = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(msg) {
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            _context9.next = 2;
            return __connect.call(this);
...
function __close(_x3, _x4) {
  return _close.apply(this, arguments);
}

function _close() {
  _close = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(code, reason) {
                ...
                return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          __close.call(_this3, code, reason);

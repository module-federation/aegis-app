...
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.js");
...
/* harmony import */ var _adapters_datasources_datasource_file_adapter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../adapters/datasources/datasource-file-adapter */ "./src/adapters/datasources/datasource-file-adapter.js");
...
var Order = {
  ...
  dependencies: {
    uuid: function uuid() {
      return (0,nanoid__WEBPACK_IMPORTED_MODULE_4__.nanoid)(8);
    }
  },
...
function cancelOrders(_x) {
  return _cancelOrders.apply(this, arguments);
}

function _cancelOrders() {
  _cancelOrders = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var cancelOrders;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cancelOrders = new Transform({
              objectMode: true,
              transform: function transform(chunk, _encoding, done) {
                if (chunk._id) delete chunk._id;
                done(null, JSON.stringify(_objectSpread(_objectSpread({}, chunk), {}, {
...
/* harmony import */ var _port_test__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./port-test */ "./src/domain/port-test.js");
...
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.js");
/**
 * webswitch (c)
 *

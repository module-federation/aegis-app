...
/* harmony import */ var async_hooks__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(async_hooks__WEBPACK_IMPORTED_MODULE_2__);
/**
 * webswitch (c)
 *
              ...
              case 0:
                ...
                return this.mesh.websocketSend(this.encode(msg), {
                  ...
                  headers: _objectSpread(_objectSpread({}, this.headers), {}, {
                    'idempotency-key': (0,nanoid__WEBPACK_IMPORTED_MODULE_3__.nanoid)()
                  })
                });
...
}(async_hooks__WEBPACK_IMPORTED_MODULE_2__.AsyncResource);
/**

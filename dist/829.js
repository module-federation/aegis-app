...
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }
var DataSourceAdapterCustomFile = function DataSourceAdapterCustomFile(url, cacheSize, DataSourceFile) {
  /**
   * Datasource adapter for AWS Dynamo DB
   */
  var DataSourceCustomFile = /*#__PURE__*/function (_DataSourceFile) {
    _inherits(DataSourceCustomFile, _DataSourceFile);
    var _super = _createSuper(DataSourceCustomFile);
    function DataSourceCustomFile() {
      _classCallCheck(this, DataSourceCustomFile);
      return _super.apply(this, arguments);
    }
    _createClass(DataSourceCustomFile, [{
      key: "save",
      value: function save(id, data) {
        _get(_getPrototypeOf(DataSourceCustomFile.prototype), "save", this).call(this, id, data);
      }
    }, {
      key: "list",
      value: function list(options) {
        return _get(_getPrototypeOf(DataSourceCustomFile.prototype), "list", this).call(this, options);
      }
    }, {
      key: "serialize",
...
var Customer = {
  ...
  validate: _util_mixins__WEBPACK_IMPORTED_MODULE_0__.validateModel,
  ...
  // },
  mixins: [(0,_util_mixins__WEBPACK_IMPORTED_MODULE_0__.freezeProperties)('customerId'), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_0__.requireProperties)('firstName', 'lastName', 'email', 'shippingAddress', 'billingAddress', 'creditCardNumber'), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_0__.validateProperties)([{
    propKey: 'email',
...
/* harmony import */ var _customer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./customer */ "./src/domain/config/customer.js");
/* harmony import */ var _inventory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inventory */ "./src/domain/config/inventory.js");
/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./todo */ "./src/domain/config/todo.js");
 // always export this
...
/* harmony import */ var _util_mixins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/mixins */ "./src/domain/util/mixins.js");
...
var Inventory = {
  ...
  endpoint: 'inventory',
  dependencies: {},
  factory: _models_inventory__WEBPACK_IMPORTED_MODULE_1__.makeInventoryFactory,
  // datasource: {
  ...
  // },
  mixins: [(0,_util_mixins__WEBPACK_IMPORTED_MODULE_2__.requireProperties)('name', 'inStock', 'category', 'price', 'purchaseOrder'), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_2__.validateProperties)([{
    propKey: 'inStock',
    "typeof": 'number',
    maxnum: 99999
  }, {
    propKey: 'category',
    values: _models_inventory__WEBPACK_IMPORTED_MODULE_1__.categories
  }, {
    propKey: 'assetType',
    values: _models_inventory__WEBPACK_IMPORTED_MODULE_1__.assetTypes
  }, {
    propKey: 'properties',
    isValid: function isValid(_obj, prop) {
      return prop.every(function (p) {
        return _models_inventory__WEBPACK_IMPORTED_MODULE_1__.properties.includes(p);
      });
    }
  }, {
    propKey: 'price',
    "typeof": 'number',
    maxnum: 999.99
  }]), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_2__.freezeProperties)('*')],
  relations: {
    orders: {
      modelName: 'order',
      type: 'oneToMany',
...
var Order = {
  ...
  mixins: [(0,_util_mixins__WEBPACK_IMPORTED_MODULE_1__.requireProperties)('orderItems', (0,_models_order__WEBPACK_IMPORTED_MODULE_0__.requiredForGuest)(['lastName', 'firstName', 'billingAddress', 'shippingAddress', 'creditCardNumber', 'email']), (0,_models_order__WEBPACK_IMPORTED_MODULE_0__.requiredForApproval)('paymentStatus'), (0,_models_order__WEBPACK_IMPORTED_MODULE_0__.requiredForCompletion)('proofOfDelivery')), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_1__.freezeProperties)('orderNo', 'customerId', (0,_models_order__WEBPACK_IMPORTED_MODULE_0__.freezeOnApproval)(['email', 'lastName', 'firstName', 'orderItems', 'orderTotal', 'billingAddress', 'shippingAddress', 'creditCardNumber', 'paymentStatus']), (0,_models_order__WEBPACK_IMPORTED_MODULE_0__.freezeOnCompletion)('*')), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_1__.updateProperties)([{
    propKey: 'orderItems',
  ...
  }]), (0,_util_mixins__WEBPACK_IMPORTED_MODULE_1__.validateProperties)([{
    propKey: 'orderStatus',
  ...
  validate: _util_mixins__WEBPACK_IMPORTED_MODULE_1__.validateModel,
  ...
  ports: {
    ...
    pickOrder: {
      ...
      type: 'outbound',
      keys: 'pickupAddress',
      callback: _models_order__WEBPACK_IMPORTED_MODULE_0__.orderPicked,
    ...
    shipOrder: {
      ...
      circuitBreaker: {
        ...
        portRetryFailed_order: {
          ...
          errorRate: 2,
          intervalMs: 60000,
          fallbackFn: _models_order__WEBPACK_IMPORTED_MODULE_0__.cancel
        },
        "default": {
          callVolume: 3,
          errorRate: 3,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              throw new _models_order__WEBPACK_IMPORTED_MODULE_0__.OrderError(_context2.t0, 404);
            case 10:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 7:
              ...
              throw new _models_order__WEBPACK_IMPORTED_MODULE_0__.OrderError(_context4.t0, 404);
            case 10:
            case "end":
...
var ToDo = {
  ...
  endpoint: 'todo',
  dependencies: {
    uuid: nanoid__WEBPACK_IMPORTED_MODULE_2__.nanoid
  },
  factory: _models_todo__WEBPACK_IMPORTED_MODULE_1__.makeToDoFactory,
  datasource: {
    factory: _adapters_datasources_datasource_adapter_file__WEBPACK_IMPORTED_MODULE_0__.DataSourceAdapterCustomFile,
    cacheSize: 4000,
    baseClass: 'DataSourceFile'
  }
};
...
var WebSwitch = {
  modelName: 'webswitch',
  endpoint: 'appfabric',
  factory: _models_webswitch__WEBPACK_IMPORTED_MODULE_0__.makeClient,
  internal: true,
  ports: {
    serviceLocatorInit: {
...
/* harmony import */ var _ports__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ports */ "./src/domain/ports.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config */ "./src/domain/config/index.js");
...
function makeToDoFactory(dependencies) {
  return function toDoFactory(_ref) {
    var text = _ref.text,

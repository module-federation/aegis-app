...
/*!******************************!*\
  ...
  \******************************/
/*! namespace exports */
/*! export listSolarSystemsPort [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "listSolarSystemsPort": () => /* binding */ listSolarSystemsPort
/* harmony export */ });
 ...
 */
function listSolarSystemsPort(_x) {
  return _listSolarSystemsPort.apply(this, arguments);
}

function _listSolarSystemsPort() {
  _listSolarSystemsPort = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return this.listRelated('SOLARSYSTEM', {
              options: {
                filter: {
                  galaxyId: data.id
                }
...
/*! export listSolarSystemsPort [provided] [no usage info] [missing usage info prevents renaming] -> ./src/domain/Galaxy.js .listSolarSystemsPort */
...
/* harmony export */   "listSolarSystemsPort": () => /* reexport safe */ _Galaxy__WEBPACK_IMPORTED_MODULE_1__.listSolarSystemsPort
/* harmony export */ });
/* harmony import */ var _order__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order */ "./src/domain/order.js");
/* harmony import */ var _Galaxy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Galaxy */ "./src/domain/Galaxy.js");

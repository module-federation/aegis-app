...
exports.modules = {
      ...
      var freezeProperties = function freezeProperties () {
        ...
        return function (o) {
          var preventUpdates = function preventUpdates (obj) {
            ...
            if (
              (mutations === null || mutations === void 0
                ? void 0
                : mutations.length) > 0
            ) {
              throw new Error(
                'cannot update readonly properties: '.concat(mutations)
              )
            }
          }
      ...
      var invokePort = function invokePort (fn, onCreate, onUpdate) {
        ...
        return /*#__PURE__*/ (function () {
          var _ref5 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee (o) {
      ...
      var execMethod = function execMethod (fn, onCreate, onUpdate) {
        ...
        return /*#__PURE__*/ (function () {
          var _ref6 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3 (o) {
              var functionType
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ trackAsyncContext: () =>
          /* binding */ trackAsyncContext,
        /* harmony export */ customHttpStatus: () =>
          /* binding */ customHttpStatus,
        /* harmony export */ testContainsMany: () =>
          /* binding */ testContainsMany
        /* harmony export */
      })
      ...
      /* harmony import */ var _check_payload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ./check-payload */ './src/domain/check-payload.js'
      )
      /* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        /*! stream */ 'stream'
      )
      /* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
        stream__WEBPACK_IMPORTED_MODULE_3__
      )
      ...
      var checkItem = function checkItem (orderItem) {
        return (
          typeof orderItem.itemId === 'string' &&
      ...
      var freezeOnApproval = function freezeOnApproval (propKey) {
        return function (o) {
          return o.orderStatus && o.orderStatus !== OrderStatus.PENDING
            ? propKey
            : null
        }
      }
      ...
      var invalidStatusChanges = [
        ...
        invalidStatusChange(OrderStatus.COMPLETE, OrderStatus.CANCELED), // Can't change final status
      ...
      var statusChangeValid = function statusChangeValid (o, propVal) {
        if (
          invalidStatusChanges.some(function (i) {
            return i(o, propVal)
          })
        ) {
              ...
              while (1) {
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    ...
                    order = options.model
                    changes = (0,
                    _check_payload__WEBPACK_IMPORTED_MODULE_2__.default)(
                      'confirmationCode',
                      options,
                      payload,
      ...
      function _refundPayment () {
        _refundPayment = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee9 (order) {
      ...
      function _verifyAddress () {
        _verifyAddress = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee10 (order) {
      ...
      function _verifyPayment () {
        _verifyPayment = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee11 (order) {
            var authorizeOrder
            return _regeneratorRuntime().wrap(
      ...
      function _verifyInventory () {
        _verifyInventory = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee12 (order) {
              ...
              while (1) {
                switch ((_context12.prev = _context12.next)) {
                  ...
                  case 5:
                    ...
                    throw new Error(
                      'low or out of stock: '.concat(
                        insufficient.map(function (i) {
                          return i.itemId
                        })
                      )
                    )
      ...
      function _getCustomerOrder () {
        _getCustomerOrder = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee13 (order) {
      ...
      var processPendingOrder = (0,
      _domain_utils__WEBPACK_IMPORTED_MODULE_1__.asyncPipe)(
        getCustomerOrder //verifyInventory,
        //verifyPayment,
        //verifyAddress
      )
      /**
      ...
      var OrderActions =
        ((_OrderActions = {}),
        _defineProperty(_OrderActions, OrderStatus.PENDING, function (order) {
          /**@type {Order} */
          getCustomerOrder(order).then(function (order) {
            OrderActions.APPROVED(order)
          })
        }),
                  ...
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      case 0:
                        ...
                        console.log(
                          'customer sentiment analysis, customer care, sales analysis'
                        )
      ...
      function handleOrderEvent (_ref4) {
        ...
        if (
          (changes !== null && changes !== void 0 && changes.orderStatus) ||
          eventType === 'CREATE'
        ) {
      ...
      function makeOrderFactory (dependencies) {
        return function createOrder (_ref5) {
          ...
          var orderItems = _ref5.orderItems,
            ...
            billingAddress =
              _ref5$billingAddress === void 0 ? null : _ref5$billingAddress,
            _ref5$shippingAddress = _ref5.shippingAddress,
            shippingAddress =
              _ref5$shippingAddress === void 0 ? null : _ref5$shippingAddress,
            _ref5$creditCardNumbe = _ref5.creditCardNumber,
            creditCardNumber =
              _ref5$creditCardNumbe === void 0 ? null : _ref5$creditCardNumbe,
            _ref5$shippingPriorit = _ref5.shippingPriority,
            shippingPriority =
              _ref5$shippingPriorit === void 0 ? null : _ref5$shippingPriorit,
            _ref5$autoCheckout = _ref5.autoCheckout,
            _autoCheckout =
              _ref5$autoCheckout === void 0 ? false : _ref5$autoCheckout,
            _ref5$saveShippingDet = _ref5.saveShippingDetails,
            saveShippingDetails =
              _ref5$saveShippingDet === void 0 ? false : _ref5$saveShippingDet,
          ...
          var order =
            ...
            _defineProperty(_order, orderTotal, 0),
            _defineProperty(_order, orderStatus, OrderStatus.PENDING),
            _defineProperty(_order, orderNo, dependencies.uuid()),
            _defineProperty(_order, 'desc', 'new order 25'),
            _defineProperty(
              _order,
              'paymentAccepted',
            ...
            _defineProperty(_order, 'logStateChange', function logStateChange (
              message
            ) {
      ...
      function _approve () {
        _approve = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee14 (order) {
            var approvedOrder
                ...
                switch ((_context14.prev = _context14.next)) {
                  case 0:
                    ...
                    return _context14.abrupt(
                      'return',
                      runOrderWorkflow(approvedOrder)
                    )
      ...
      function _cancel () {
        _cancel = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee15 (order) {
            var canceledOrder
                ...
                switch ((_context15.prev = _context15.next)) {
                  ...
                  case 2:
                    ...
                    return _context15.abrupt(
                      'return',
                      runOrderWorkflow(canceledOrder)
                    )
      ...
      function _checkout () {
        _checkout = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee16 (order) {
      ...
      function _returnInventory () {
        _returnInventory = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee17 (order) {
      ...
      function _returnShipment () {
        _returnShipment = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee18 (order) {
      ...
      function _returnDelivery () {
        _returnDelivery = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee19 (order) {
      ...
      function _cancelPayment () {
        _cancelPayment = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee20 (order) {
      ...
      function _cancelOrders () {
        _cancelOrders = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee21 (data) {
      ...
      function _approveOrders () {
        _approveOrders = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee22 (data) {
      ...
      function _trackAsyncContext () {
        _trackAsyncContext = _asyncToGenerator(
      ...
      function _customHttpStatus () {
        _customHttpStatus = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee24 (data) {
            return _regeneratorRuntime().wrap(
                  ...
                  switch ((_context24.prev = _context24.next)) {
                    case 0:
                      ...
                      throw new OrderError(
                        data.args.message || 'custom status',
                        data.args.code
                      )
      ...
      function _testContainsMany () {
        _testContainsMany = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee25 (data) {
            return _regeneratorRuntime().wrap(
  ...
  \*****************************/
    ...
    /***/ (
      ...
      __webpack_require__.r(__webpack_exports__)
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ cancelOrders: () =>
          /* reexport safe */ _order__WEBPACK_IMPORTED_MODULE_0__.cancelOrders,
        /* harmony export */ approveOrders: () =>
          /* reexport safe */ _order__WEBPACK_IMPORTED_MODULE_0__.approveOrders,
        /* harmony export */ trackAsyncContext: () =>
          /* reexport safe */ _order__WEBPACK_IMPORTED_MODULE_0__.trackAsyncContext,
        /* harmony export */ customHttpStatus: () =>
          /* reexport safe */ _order__WEBPACK_IMPORTED_MODULE_0__.customHttpStatus,
        /* harmony export */ testContainsMany: () =>
          /* reexport safe */ _order__WEBPACK_IMPORTED_MODULE_0__.testContainsMany
        /* harmony export */
      })
  ...
  \*****************************/
    ...
    /***/ (
      ...
      var asyncPipe = function asyncPipe () {
        for (
          var _len3 = arguments.length, func = new Array(_len3), _key3 = 0;
          _key3 < _len3;
          _key3++
        ) {

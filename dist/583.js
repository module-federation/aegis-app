...
exports.modules = {
  ...
  \*****************************/
    ...
    /***/ (
      ...
      var Order = {
        ...
        datasource: {
          factory:
            _adapters_datasources_datasource_mongodb__WEBPACK_IMPORTED_MODULE_2__.DataSourceAdapterMongoDb,
          url: 'mongodb://localhost:27017',
  ...
  \******************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _domain_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ../domain/utils */ './src/domain/utils.js'
      )
      ...
      function processUpdate (model, changes) {
        ...
        var updates = model[premixins]
          ? _domain_utils__WEBPACK_IMPORTED_MODULE_0__.compose.apply(
              void 0,
              ...
              .map(function (key) {
                return obj[key]
                  ? _defineProperty(
                      {},
                      key,
                      (0, _domain_utils__WEBPACK_IMPORTED_MODULE_0__.encrypt)(
                        obj[key]
                      )
                    )
                  : {}
                  ...
                  .map(function (key) {
                    return _this[key]
                      ? _defineProperty(
                          ...
                          key,
                          (0,
                          _domain_utils__WEBPACK_IMPORTED_MODULE_0__.decrypt)(
                            _this[key]
                          )
                        )
                      : {}
              ...
              .map(function (key) {
                return obj[key]
                  ? _defineProperty(
                      {},
                      key,
                      (0, _domain_utils__WEBPACK_IMPORTED_MODULE_0__.hash)(
                        obj[key]
                      )
                    )
                  : {}
      ...
      function evaluateUniqueness (v, o, propVal) {
        var compareVal = v.unique.encrypted
          ? (0, _domain_utils__WEBPACK_IMPORTED_MODULE_0__.encrypt)(propVal)
          : propVal
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _check_payload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./check-payload */ './src/domain/check-payload.js'
      )
      /* harmony import */ var _domain_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ../domain/utils */ './src/domain/utils.js'
      )
      ...
      function _refundPayment () {
        _refundPayment = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee12 (order) {
              ...
              while (1) {
                switch ((_context13.prev = _context13.next)) {
                  ...
                  case 6:
                    ...
                    custInfo = _objectSpread(
                      _objectSpread({}, customer.decrypt()),
                      {},
                      {
                  ...
                  case 9:
                    ...
                    console.info(
                      'update order with data from existing customer',
                      custInfo
                    )
                  ...
                  case 12:
                    ...
                    _custInfo = _objectSpread(
                      _objectSpread({}, order.decrypt()),
                      {},
                      {
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 3:
                          ...
                          _context.next = 6
                          return (0,
                          _domain_utils__WEBPACK_IMPORTED_MODULE_2__.async)(
              ...
              while (1) {
                switch ((_context15.prev = _context15.next)) {
                  case 0:
                    ...
                    if (
                      !(
                        (changes === null || changes === void 0
                          ? void 0
                          : changes.orderStatus) || eventType === 'CREATE'
                      )
                    ) {
                      _context15.next = 3
                      break
                  ...
                  switch ((_context6.prev = _context6.next)) {
                    case 0:
                      ;(orderItems = _ref7.orderItems),
                        ...
                        (fibonacci =
                          _ref7$fibonacci === void 0 ? 10 : _ref7$fibonacci)
  ...
  \*****************************/
    ...
    /***/ (
      ...
      /* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! nanoid */ 'webpack/sharing/consume/default/nanoid/nanoid'
      )
      /* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
        nanoid__WEBPACK_IMPORTED_MODULE_1__
      )
  ...
  \*********************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _domain_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./domain/utils */ './src/domain/utils.js'
      )
      ...
      var Registry = {
        ...
        generateShippingEventData: function generateShippingEventData (
          ...
          var trackingId = (0,
          _domain_utils__WEBPACK_IMPORTED_MODULE_1__.uuid)()
  ...
  \************************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _src_event_dispatcher__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ../../src/event-dispatcher */ './src/event-dispatcher.js'
      )
      /* harmony import */ var _src_service_registry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ../../src/service-registry */ './src/service-registry.js'
      )
      ...
      var dispatcher = new _src_event_dispatcher__WEBPACK_IMPORTED_MODULE_0__.EventDispatcher(
        Event
      )
      dispatcher.registerCallback(
        inventoryChannel,
        _src_service_registry__WEBPACK_IMPORTED_MODULE_1__.Registry.inventoryCallbackFactory()
      )
      dispatcher.registerCallback(
        shippingChannel,
        _src_service_registry__WEBPACK_IMPORTED_MODULE_1__.Registry.shippingCallbackFactory()
      )
      dispatcher.init()
  ...
  \****************************************/
    ...
    /***/ (
      ...
      /* harmony import */ var _src_services_event_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ../../src/services/event-service */ './src/services/event-service.js'
      )
              ...
              return regeneratorRuntime.wrap(function _callee$ (_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.next = 2
                      return _src_services_event_service__WEBPACK_IMPORTED_MODULE_0__.Event.notify(
                        'orderChannel',
                        JSON.stringify({
                          eventData: eventData,
                          eventName: eventName,

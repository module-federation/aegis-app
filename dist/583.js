...
var User = {
  ...
  endpoint: "users",
  dependencies: {
    uuid: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
...
function processUpdate(model, changes) {
  ...
  var updates = model[premixins] ? Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(void 0, _toConsumableArray(model[premixins].values()))(changes) : changes;

  var updated = _objectSpread(_objectSpread({}, model), updates);

  return model[postmixins] ? Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(void 0, _toConsumableArray(model[postmixins].values()))(updated) : updated;
}
/**
 * @deprecated
  ...
  return function (o) {
    ...
    var encryptProps = function encryptProps(obj) {
      return keys.map(function (key) {
        return obj[key] ? _defineProperty({}, key, Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(obj[key])) : {};
      }).reduce(function (p, c) {
        return _objectSpread(_objectSpread({}, p), c);
      });
    };
    ...
    return _objectSpread(_objectSpread({
      ...
      decrypt: function decrypt() {
        ...
        return keys.map(function (key) {
          return _this[key] ? _defineProperty({}, key, Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_this[key])) : {};
        }).reduce(function (p, c) {
          return _objectSpread(_objectSpread({}, p), c);
        });
      }
...
function evaluateUniqueness(v, o, propVal) {
  var compareVal = v.unique.encrypted ? Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(propVal) : propVal;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(customerOrder.authorizePayment(paymentAuthorized));
          ...
          case 11:
            _context.next = 13;
            return Object(function webpackMissingModule() { var e = new Error("Cannot find module '../lib/utils'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(payment.object.validateAddress(addressValidated));
...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../event-dispatcher'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../service-registry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var dispatcher = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '../event-dispatcher'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(Event);
dispatcher.registerCallback(inventoryChannel, Object(function webpackMissingModule() { var e = new Error("Cannot find module '../service-registry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())());
dispatcher.registerCallback(shippingChannel, Object(function webpackMissingModule() { var e = new Error("Cannot find module '../service-registry'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())());
dispatcher.init();
...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../services/event-service'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Object(function webpackMissingModule() { var e = new Error("Cannot find module '../services/event-service'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("orderChannel", JSON.stringify({
              eventData: eventData,
              eventName: eventName,

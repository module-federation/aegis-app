        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              }, _defineProperty(_order, orderTotal, total), _defineProperty(_order, orderStatus, OrderStatus.PENDING), _defineProperty(_order, orderNo, dependencies.uuid()), _defineProperty(_order, "desc", 'new order 19'), _defineProperty(_order, "paymentAccepted", function paymentAccepted() {

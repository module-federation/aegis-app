...
/*! runtime requirements: __webpack_require__, __webpack_exports__, module.loaded, module.id, module, __webpack_require__.nmd, __webpack_require__.* */
/*! CommonJS bailout: exports is used directly at 3058:60-67 */
/*! CommonJS bailout: module.exports is used directly at 3058:164-178 */
...
var Module = function () {
  ...
  return function (Module) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_sayHi')) {
      Object.defineProperty(Module['ready'], '_sayHi', {
        configurable: true,
        get: function get() {
          abort('You are getting _sayHi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
        }
      });
      Object.defineProperty(Module['ready'], '_sayHi', {
        configurable: true,
        set: function set() {
          abort('You are setting _sayHi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js');
        }
      });
    }
    ...
    if (ENVIRONMENT_IS_NODE) {
      if (!((typeof process === "undefined" ? "undefined" : _typeof(process)) === 'object' && "function" === 'function')) throw new Error('not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)');
...
/* harmony import */ var _demo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./demo */ "./src/wasm/demo.js");
...
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _demo__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== "default") __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _demo__WEBPACK_IMPORTED_MODULE_0__[__WEBPACK_IMPORT_KEY__]
